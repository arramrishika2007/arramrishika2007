...
[![GitHub](https://img.shields.io/badge/GitHub-arramrishika2007-181717?style=flat-square&logo=github)](https://github.com/arramrishika2007)

</div>

---

I'm a Full Stack Developer from **Kakatiya Institute of Technology and Science, Warangal**. I build scalable, production-ready applications with clean architecture and real-world deployment. I love turning complex ideas into working products — from backend APIs to polished frontends.
...
### [AppointUnified](https://appointunified-v1.vercel.app) — Unified Appointment Booking Platform
> A full-stack appointment booking system for Healthcare, Government, and Services sectors

- 🏗 **Tech**: Spring Boot · Next.js · PostgreSQL · Redis · WebSockets · SendGrid · Twilio
- ⚡ **Features**: Real-time queue tracking, virtual meetings, AI support assistant, payment deposits, complaint management
- 🌐 **Deployed**: Vercel (frontend) + Render (backend)
- 🔗 [Live App](https://appointunified-v1.vercel.app) · [GitHub](https://github.com/arramrishika2007/appointunified-v1)
...
[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/rishika-arram/)
[![Live App](https://img.shields.io/badge/View_Live_App-6366F1?style=for-the-badge&logo=vercel&logoColor=white)](https://appointunified-v1.vercel.app)
